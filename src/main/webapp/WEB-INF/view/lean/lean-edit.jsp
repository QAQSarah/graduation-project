...
<body class="layui-anim layui-anim-up">
	...
	<div class="layui-row">
			<div style="float: left; width: 45%; margin-right: 5%">
				<lable> <b>学习资源名称:</b></lable>
				<br> <input hidden="hidden" value="${lean.id }" id="id"/> <input type="text" id="sreachName" placeholder="请输入分类名称"
					autocomplete="off" class="layui-input" style="width: 100%" value="${lean.name }">
			</div>
			<div style="float: left; width: 45%; margin-right: 5%">
				<lable> <b>下载路径:</b></lable>
				<br> <input type="text" id="sreachIntro" placeholder="请输入简介"
					autocomplete="off" class="layui-input" style="width: 100%" value="${lean.downloadurl }">
			</div>
		</div>
		<div class="layui-row">
			<div style="float: left; width: 45%; margin-right: 5%">
				<lable> <b>所属分类:</b></lable>
				<br> <select id="categoryId">
	...
	<script>
		...
		$("#tjbutton").click(function() {
			...
			var introduce=$("#sreachIntro").val();
			var categoryId = $("#categoryId").val();
			var id=$("#id").val();
			$.post("/it_web/line/editLean.do", {
				name : title,
				id:id,
				introduce:introduce,
