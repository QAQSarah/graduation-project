...
<body class="login-bg">
	...
	<div class="login layui-anim layui-anim-up">
		<label style="float: right; margin: -20px 50px 0 0;"><a
			href="show.do"><b>返回主页</b></a> </label>
		...
		<form class="layui-form" id="registerform" method="post"
			...
			<div class="layui-form-item">
				<label for="L_repass" class="layui-form-label"> </label> <input
					type="button" class="layui-submit" value="注册" id="registerId" />
	...
	<script>
		...
		$("#registerId").click(function() {
			...
			if (userimg == null || userimg.length == 0) {
				...
				registerform.attr("action", "/it_web/registerwithimg.do");
				registerform.submit();
			}
